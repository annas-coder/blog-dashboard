...
const { useGetPostsQuery } = blogApi;
...
function Home() {
    _s();
    const { data, error, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$index$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["useGetPostsQuery"])();
    if (isLoading) {
...
_s(Home, "MOgCRS3kkPNf1EhfiygHyjfw8x4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$index$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["useGetPostsQuery"]
    ];
});
_c = Home;
var _c;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1798f582._.js.map
...
const { useGetBlogListQuery, useGetBlogByIdQuery, useCreateBlogPostMutation } = blogApi;
...
const Blog = ()=>{
    _s();
    const { data, error, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$index$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["useGetBlogListQuery"])();
    if (isLoading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Loader, {}, void 0, false, {
...
_s(Blog, "s8cZ34gupYjnnmlU6HUjDXJz9ec=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__169aae34._.js.map
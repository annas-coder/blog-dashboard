...
;
function Home() {
    fetch("https://67f8fa0b094de2fe6e9ffb9b.mockapi.io/api/blog/list").then((res)=>res.json()).then((res)=>console.log(res)).catch((error)=>console.log(error));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__edee8a3b._.js.map